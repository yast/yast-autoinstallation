...
require "autoinstall/clients/files_auto"

describe Y2Autoinstallation::Clients::FilesAuto do
  let(:mod) { Yast::AutoinstFile }
  describe "#import" do
  ...
  describe "#change" do
    ...
    it "runs scripts dialog" do
      ...
      expect(subject).to receive(:AddEditFile).and_call_original
