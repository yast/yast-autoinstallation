  ...
  module Clients
    ...
    class Autoyast < Yast::Client
      ...
      def main
        ...
        cmdline = {
          ...
          "options"    => {
            ...
            "run-scripts" => { "type" => "boolean", "help" => "run also scripts that are defined in profile. By default false. Example: run-scripts=true" }
          },
          "mappings"   => {
      ...
      def check_profile(options)
        ...
        Yast::CommandLine.Print("Resulting autoyast profile is at #{target_file}")
