...
module Y2Autoinstallation
  ...
  class AutoinstIssuesPresenter
    ...
    # Constructor
    #
    # @param issues_list [Y2Autoinstallation::AutoinstIssues::List] List of issues
    ...
    def error_text(issues)
      Yast::HTML.Para(
        _("Important issues have been detected while reading AutoYaST configuration file:")
      ) + issues_list_content(issues)
    end
